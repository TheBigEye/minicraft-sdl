 ...
 *
 * Glyphs live in the spritesheet starting at tile 30. chars[] maps a glyph
 * index to its ASCII character, and chars_lookup[] is the reverse table
 * (ASCII -> glyph index), built once by font_pre_init().
 */
#ifndef GFX_FONT_H_
#define GFX_FONT_H_
...
/* Draws the bordered panel used by menus, with `title` along its top edge. */
